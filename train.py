...
class RandomColorJitter:
    def __init__(self, brightness=0.2, contrast=0.2, saturation=0.3, hue=0.1, p=0.5):
        self.p = p
...
def joint_transform(img, label, do_rotate=False, do_multiply=False, do_blur=False, do_flip=False, do_colorjitter=False):
    ...
    if do_colorjitter:
        img = RandomColorJitter(p=0.5, brightness=0.2, contrast=0.2, saturation=0.3, hue=0.1)(img)
